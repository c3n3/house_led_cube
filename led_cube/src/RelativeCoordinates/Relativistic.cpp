...
void Relativistic::setLED(ui8 x, ui8 y, ui8 z, Directions direction, uint8_t power) {
    toStandard(x, y, z, direction);
    set_led(x, y, z, power);
}

void Relativistic::protectedSetLED(ui8 x, ui8 y, ui8 z, Directions direction, uint8_t power) {
    toStandard(x, y, z, direction);
    set_led(x, y, z, power);
}
...
void Relativistic::setRandomLED(uint8_t leds, Relativistic::Directions direction, uint8_t power, boolean threeD)
{
    if (!threeD)
    {
...
void Relativistic::moveRow(uint8_t firstCoord, uint8_t secondCoord, Directions viewPoint, uint16_t specificColor, boolean collective, uint8_t start, uint8_t end, uint8_t power)
{
