...
//     for (int i = -1; i < 2; i += 2)
//     {
//         protected_set_led(normalizedX + i, normalizedY, normalizedZ, draw ? 0x001F : 0x0000);
//         protected_set_led(normalizedX, normalizedY + i, normalizedZ, draw ? 0x001F : 0x0000);
//         protected_set_led(normalizedX, normalizedY, normalizedZ + i, draw ? 0x001F : 0x0000);
//     }
//     protected_set_led(normalizedX, normalizedY, normalizedZ, draw ? 0x001F : 0x0000); // for effeciancy not readability
// }
...
//     const ui8 length = AXIS_MAX - maxX;
//     const ui8 height = AXIS_MAX - maxY;
...
//     {
//         Relativistic::setDirectionalLED(i, y, 0, wall, true, clear == false ? color : 0);
//         Relativistic::setDirectionalLED(i, y + height - 1, 0, wall, true, clear == false ? color : 0);
//     }
//     for (int i = y; i < y + height; i++)
//     {
//         Relativistic::setDirectionalLED(x, i, 0, wall, true, clear == false ? color : 0);
//         Relativistic::setDirectionalLED(x + length - 1, i, 0, wall, true, clear == false ? color : 0);
//     }
// }
