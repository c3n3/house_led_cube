...
//             set_led(x, self.y, self.z, '+');
//         }
//         for (int y = 0; y < CUBE_LENGTH; y++) {
//             set_led(self.x, y, self.z, '+');
//         }
//         blink = !blink;
//     }
...
//             set_led(mines[i].x, mines[i].y, mines[i].z, mine);
//         }
//     }
...
//             return;
//         }
//         protected_set_led(x, y, z, handleMineCount(total));
//     }
...
//     void saveBank() {
//         for (int i = 0; i < CUBE_LENGTH; i++) {
//             bank[i] = get_led(i, self.y, self.z);
//         }
//         for (int i = 0; i < CUBE_LENGTH; i++) {
//             bank[i + CUBE_LENGTH] = get_led(self.x, i, self.z);
//         }
//         for (int i = 0; i < CUBE_LENGTH; i++) {
//             bank[i + CUBE_LENGTH * 2] = get_led(self.x, i, self.z);
//         }
//     }

//     void printBank() {
//         for (ui8 i = 0; i < CUBE_LENGTH; i++) {
//             protected_set_led(i, self.y, self.z, bank[i]);
//         }
//         for (ui8 i = 0; i < CUBE_LENGTH; i++) {
//             protected_set_led(self.x, i, self.z, bank[i + CUBE_LENGTH]);
//         }
//         for (ui8 i = 0; i < CUBE_LENGTH; i++) {
//             protected_set_led(self.x, self.y, i, bank[i + CUBE_LENGTH * 2]);
//         }
//     }
