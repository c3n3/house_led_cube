...
//      * 
//      * @param drawEffect this is the Draw burst function, you must create a function that draws whatever effect you want base on position, power and intervals
...
//      */
//     FireWorkEffect(void (*drawEffect)(ui8 x, ui8 y, ui8 z, uint8_t& power, int interval), ui8 maxIntervals, uint16_t inter);

//     // this is the draw burst function from above
//     void (*drawEffect)(ui8 x, ui8 y, ui8 z, uint8_t& power, int interval);
...
//     void reload(Particle r, uint32_t fuse, uint8_t burstColor, FireWorkEffect f);
...
//      * @param burstuint8_t the power of the firework effect, does not need to be utilized
//      */
//     Firework(Particle rocket, uint32_t fuseLength, FireWorkEffect effect, uint8_t burstuint8_t = 0xFFFF);
// };